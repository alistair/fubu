...
RESULTS_DIR = "results"
PRODUCT = "fubu"
COPYRIGHT = 'Copyright 2012 fubu. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/fubu.sln', :clrversion => CLR_TOOLS_VERSION
